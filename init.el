...
(custom-set-variables
 ...
 '(package-selected-packages
   '(figlet poly-R poly-markdown poly-noweb poly-org elgrep yasnippet-classic-snippets yasnippet-snippets vscode-icon all-the-icons all-the-icons-completion all-the-icons-dired all-the-icons-ibuffer neotree ein transpose-frame imenu-list outline-toc elpy pass calmer-forest-theme dired-single async auctex ox-pandoc r-autoyas ess zenburn-theme yaml-mode visual-regexp typo tango-2-theme solarized-theme smex smartparens powerline polymode pandoc-mode multiple-cursors markdown-mode magit latex-pretty-symbols julia-mode jedi idle-highlight-mode flycheck flx-ido expand-region exec-path-from-shell emmet-mode draft-mode dracula-theme csv-mode company-web company-statistics company-quickhelp company-math company-auctex browse-kill-ring anti-zenburn-theme ag adaptive-wrap)))
(custom-set-faces
