...
#+RESULTS:
| org-table-stripes-enable | org-mode-reftex-setup | (lambda nil (local-set-key \216 (quote outline-next-visible-heading)) (local-set-key \220 (quote outline-previous-visible-heading)) (local-set-key \225 (quote outline-up-heading)) (local-set-key \227 (quote org-table-copy-region)) (local-set-key \231 (quote org-table-paste-rectangle)) (local-set-key \214 (quote org-table-sort-lines)) (local-set-key \311 (quote org-toggle-iimage-in-org))) | (lambda nil (add-to-list (quote org-tab-first-hook) (quote yas-org-very-safe-expand))) | (lambda nil (set-face-attribute (quote org-level-1) nil :height 1.5) (set-face-attribute (quote org-level-2) nil :height 1.2) (set-face-attribute (quote org-level-3) nil :height 1.1) (set-face-attribute (quote org-level-4) nil :height 1.1) (set-face-attribute (quote org-level-5) nil :height 1.1)) | turn-on-flyspell | er/add-org-mode-expansions | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-block-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
